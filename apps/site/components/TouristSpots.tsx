...
const TouristSpots: React.FC = () => {
  ...
  const spots: TouristSpot[] = [
    {
      id: 'boiadeiro',
      title: 'Balneario Corrego Boiadeiro',
      desc: 'Atrativo urbano a cerca de 500 m do centro, procurado para banho, descanso e pausas rapidas durante a estadia.',
    ...
    },
    {
      ...
      desc: 'Queda do Rio Araguaia no bairro Gabiroba, de facil acesso e uma das visitas mais simples para quem quer conhecer a cidade.',
    ...
    {
      id: 'bilinao',
      title: 'Cachoeira do Estadio Bilinao',
      desc: 'Refugio natural proximo da area urbana, citado pelo municipio como uma das quedas de facil acesso no entorno do centro.',
    ...
    },
    {
      ...
      desc: 'Queda situada a cerca de 3 km do centro, boa opcao para quem quer estender o roteiro sem sair muito da cidade.',
    ...
    {
      id: 'couto-magalhaes',
      title: 'Cachoeira Couto Magalhaes',
      desc: 'Atrativo de natureza mais intensa, a 35 km do centro. O acesso final pede mais atencao e vale combinar apoio local antes de sair.',
    ...
    },
    {
      ...
      desc: 'Opcao para quem quer ampliar o roteiro regional. Fica na MT-100, em uma visita mais longa voltada a natureza e contemplacao.',
  ...
  useEffect(() => {
    ...
    const initMap = async () => {
      ...
      html: `<div class="bg-[#002D44] p-2.5 rounded-2xl shadow-2xl border-2 border-white flex flex-col items-center transform -translate-y-4 animate-bounce">
      ...
      .addTo(map)
      .bindPopup(
        '<div class="p-4 text-center"><p class="font-black text-[#002D44] text-[10px] uppercase tracking-widest">Sua localizacao</p><p class="text-sm font-bold text-slate-500">Araguaia Palace Hotel</p></div>',
      );

      spots.forEach((spot) => {
        const spotIcon = L.divIcon({
        html: `<div class="p-2 rounded-xl shadow-xl border-2 border-white bg-white text-[#E31B23] hover:scale-110 transition-transform cursor-pointer">
          ...
          <div style="padding:18px;">
            <div style="display:grid;grid-template-columns:1fr 92px;gap:10px;margin-bottom:14px;">
              <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:18px;padding:12px;">
                <p style="margin:0 0 5px 0;font-size:9px;font-weight:900;text-transform:uppercase;letter-spacing:.22em;color:#94a3b8;">Distancia</p>
  ...
  useEffect(() => {
    ...
    mapInstanceRef.current.setView(activeSpot.latlng, activeSpot.id === 'gota-santa' ? 10 : 14, {
      animate: true,
    });
    marker.openPopup();
    ...
    <section id="pontos-turisticos" className="py-24 bg-slate-50 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-up">
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-[#002D44] serif">Exploracao Regional</h2>
          ...
          <p className="text-slate-500 mt-8 max-w-3xl mx-auto text-lg italic serif">
            Atrativos destacados com base no roteiro turistico oficial do municipio de Alto Araguaia.
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch">
          <div className="lg:col-span-8 h-[500px] md:h-[700px] rounded-[3rem] md:rounded-[4rem] shadow-2xl overflow-hidden border-[10px] border-white bg-slate-100 z-10 relative">
            ...
            <div className="mt-6 p-10 bg-[#002D44] rounded-[3.5rem] text-white shadow-2xl relative overflow-hidden group">
              ...
              <div className="relative z-10 space-y-6">
                ...
                <p className="text-sm text-white/70 leading-relaxed font-light italic">
                  Para os passeios mais longos, confirme condicoes de acesso e apoio local com a recepcao antes
                  de sair.
                </p>
                <button
