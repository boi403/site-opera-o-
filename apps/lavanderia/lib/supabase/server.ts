...
// Cliente com service role — só usar em Route Handlers/servidor, nunca no browser.
// Necessário para o admin ler/gravar ignorando RLS quando fizer sentido (ex.: webhooks).
